...
function loginUser(){
  ...
  const savedUser =
  JSON.parse(localStorage.getItem("decisionOSUser"));
  if(!savedUser){
...
window.addEventListener("load", ()=>{
  const loggedIn =
  localStorage.getItem("decisionOSLoggedIn");
  const savedUser =
  JSON.parse(localStorage.getItem("decisionOSUser"));
...
window.addEventListener("load", ()=>{
  const savedTheme =
  localStorage.getItem("decisionTheme") || "dark";
...
const burnRate =
document.getElementById("burnRate");

const burnValue =
document.getElementById("burnValue");
...
const runwayValue =
document.getElementById("runwayValue");
...
const horizonValue =
document.getElementById("horizonValue");
...
function switchSimulator(type, btn){
  ...
  if(type === "startup"){
    ...
    document.getElementById("activeModuleName").innerText =
